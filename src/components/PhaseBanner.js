...
const phaseCheck = (props, propName, componentName) => {
  if (!props.phase) {
    return new Error(
      `Please specify whether your project is in 'alpha' or 'beta' or 'demo' i.e: <PhaseBanner phase="alpha">message</PhaseBanner> `,
    )
  }

  if (!['alpha', 'beta', 'demo'].includes(props.phase)) {
    return new Error(`Invalid phase '${props.phase}', try 'alpha' or 'beta' or 'demo'`)
  }
}
